...
//Step 4: 執行 SQL 指令	
		...
		{			
			...
			//out.print("<a href='"+rs.getString("nofile")+".jsp'><input type='button' value='add to cart'></a>");
			out.print("<a href='"+rs.getString("nofile")+".jsp'><input type='button' value='觀看'></a>");
			//session.setAttribute("nofile",rs.getString("nofile"));
			out.print("</li>");
		}
			...
			%>
				...
				<ul class="menu-list">
					<li>
						...
						<p class="menu-text">招牌漢堡<br><b>80元</b></p>
						<input type="button" value="add to cart">
					</li>
					<li>
						<img src="img/item/14.jpg" alt="">
						<p class="menu-text">煙熏雞蛋堡<br><b>60元</b></p>
						<input type="button" value="add to cart">
					</li>
					<li>
						<img src="img/item/15.jpg" alt="">
						<p class="menu-text">厚片培根漢堡<br><b>70元</b></p>
						<input type="button" value="add to cart">
					</li>
					<li>
						<img src="img/item/16.jpg" alt="">
						<p class="menu-text">鮪魚玉米漢堡<br><b>60元</b></p>
						<input type="button" value="add to cart">
					</li>
					<li>
