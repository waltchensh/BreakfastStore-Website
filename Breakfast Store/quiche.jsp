...
//Step 3: 選擇資料庫   
		   ...
		   sql="select * from omelet where id";
	...
	%>
		<!--
			...
			<li>
				...
				<p class="menu-text">蔥抓餅<br><b>50元</b></p>
				<input type="button" value="add to cart">
			</li>
			<li>
				<img src="img/item/3.jpg" alt="">
				<p class="menu-text">起司蛋餅<br><b>60元</b></p>
				<input type="button" value="add to cart">
			</li>
			<li>
				<img src="img/item/4.jpg" alt="">
				<p class="menu-text">肉鬆蛋餅<br><b>60元</b></p>
				<input type="button" value="add to cart">
			</li>
			<li>
			...
			<li>
				...
				<p class="menu-text">蘿蔔糕<br><b>70元</b></p>
				<input type="button" value="add to cart">
			</li>-->
		</ul>
	</section><!-- /#menu -->
