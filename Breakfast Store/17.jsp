...
//Step 3: 選擇資料庫   
		   ...
		   sql="select * from burger where id=5";
...
%>
	...
	<form method="post" action="addcart.jsp">
		...
		<p><br><br>
			...
			<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="hidden" name="name" value="薯餅滿福堡">
		...
		可搭配套餐<br>
		<a href="1.jsp">
			<img src="img/item/1.jpg" alt="玉米培根蛋餅">
		</a>
	</div>
<%	
...
<table style="margin: auto;text-align: center;width: 600px;">
 <tr>
  ...
  <td bgcolor="#ECE3D0" style="width:67%;">工具人</td>
 </tr>
 <tr>
  <td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
  <td bgcolor="#ECE3D0">很淡</td>
 </tr>
</table><br><br>
...
<table style="margin: auto;text-align: center;width: 600px;">
 <tr>
  <td bgcolor="#d8c7a0" style="width:33%;">評論者 :&nbsp;</td>
  <td bgcolor="#ECE3D0" style="width:67%;">RONDO</td>
 </tr>
 <tr>
  <td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
