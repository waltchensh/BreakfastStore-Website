...
//Step 3: 選擇資料庫   
		   ...
		   sql="select * from omelet where id=1";
...
//Step 4: 執行 SQL 指令	
	...
	<form method="post" action="addcart.jsp">
		...
		<p><br><br>
			...
			<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="hidden" name="name" value="玉米培根蛋餅">
	...
	<div class="side">
		可搭配套餐<br>
		<a href="17.jsp">
			<img src="img/item/17.jpg" alt="薯餅滿福堡">
		</a>
	</div>
...
<table style="margin: auto;text-align: center;width: 600px;">
	<tr>
		...
		<td bgcolor="#ECE3D0" style="width:67%;">無名者</td>
	</tr>
	<tr>
		<td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
		<td bgcolor="#ECE3D0" >我覺得可以</td>
	</tr>
</table><br><br>
<table style="margin: auto;text-align: center;width: 600px;">
	<tr>
		<td bgcolor="#d8c7a0" style="width:33%;">評論者 :&nbsp;</td>
		<td bgcolor="#ECE3D0" style="width:67%;">王逆宏</td>
	</tr>
	<tr>
		<td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
		<td bgcolor="#ECE3D0">好吃！</td>
	</tr>
</table><br><br>
</div>
