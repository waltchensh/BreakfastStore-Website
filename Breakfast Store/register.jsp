		...
		<form method="post" action="addmember.jsp">
			<table>
				<tr>
					<td>姓名 :&nbsp;</td>
					<td>
					<input type="text" name="register_name" maxlength="10" required>
					</td>
				</tr>
				<tr>
					<td>帳號 :&nbsp;</td>
					<td>
					<input type="text" name="register_username" maxlength="20" required>
					</td>
				</tr>
				<tr>
					<td>密碼 :&nbsp;</td>
					<td>
					<input type="password" name="register_password" maxlength="20" required>
					</td>
				</tr>
				<tr>
					<td>確認密碼 :&nbsp;</td>
					<td>
					<input type="password" name="register_checkpwd" maxlength="20" required>
					</td>
				</tr>
				<tr>
					<td>地址 :&nbsp;</td>
					<td>
					<input type="text" name="register_address" maxlength="30" required>
					</td>
				</tr>
				<tr>
					<td>性別 :&nbsp;</td>
					<td>
					<input type="radio" name="register_sexual" value="man" checked="true">男&nbsp;
				...
				<tr>
					<td>電話 :&nbsp;</td>
					<td>
					<input type="text" name="register_phone" maxlength="20" required>
					</td>
				</tr>
				<tr>
					<td>信箱 :&nbsp;</td>
					<td>
					<input type="email" name="register_email" maxlength="30" required>
					</td>
				</tr>
				<tr>
