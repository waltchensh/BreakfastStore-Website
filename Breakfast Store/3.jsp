...
//Step 3: 選擇資料庫   
		   ...
		   sql="select * from omelet where id=3";
...
%>
	...
	<form method="post" action="addcart.jsp">
		...
		<p><br><br>
			...
			<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="hidden" name="name" value="起司蛋餅">
...
<table style="margin: auto;text-align: center;width: 600px;">
	...
	<tr>
		...
		<td bgcolor="#ECE3D0">起司就起司，吃起來還不都這樣！</td>
	</tr>
</table><br><br>
<table style="margin: auto;text-align: center;width: 600px;">
	<tr>
	...
	<tr>
		<td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
		<td bgcolor="#ECE3D0">起司就起司，還甚麼芝士勒。</td>
	</tr>
</table><br><br>
</div>
