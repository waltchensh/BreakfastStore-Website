...
//Step 3: 選擇資料庫   
		   ...
		   sql="select * from others where id=6";
...
%>
	...
	<form method="post" action="addcart.jsp">
		...
		<p><br><br>
			...
			<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="hidden" name="name" value="奶茶">
	...
	<div class="side">
		可搭配套餐<br>
		<a href="3.jsp">
			<img src="img/item/3.jpg" alt="起司蛋餅">
		</a>
	</div>
...
<table style="margin: auto;text-align: center;width: 600px;">
	<tr>
		...
		<td bgcolor="#ECE3D0" style="width:67%;">諺諺</td>
	</tr>
	<tr>
		<td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
		<td bgcolor="#ECE3D0">阿？</td>
	</tr>
</table><br><br>
<table style="margin: auto;text-align: center;width: 600px;">
	<tr>
		<td bgcolor="#d8c7a0" style="width:33%;">評論者 :&nbsp;</td>
		<td bgcolor="#ECE3D0" style="width:67%;">肥貓</td>
	</tr>
	<tr>
		<td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
		<td bgcolor="#ECE3D0">好。</td>
	</tr>
</table><br><br>
</div>
