...
//Step 3: 選擇資料庫   
		   ...
		   sql="select * from burger where id=4";
...
%>
	...
	<form method="post" action="addcart.jsp">
		...
		<p><br><br>
			...
			<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="hidden" name="name" value="鮪魚玉米堡">
...
<table style="margin: auto;text-align: center;width: 600px;">
 ...
 <tr>
  ...
  <td bgcolor="#ECE3D0">沒有味道</td>
 </tr>
</table><br><br>
<table style="margin: auto;text-align: center;width: 600px;">
 <tr>
  <td bgcolor="#d8c7a0" style="width:33%;">評論者 :&nbsp;</td>
  <td bgcolor="#ECE3D0" style="width:67%;">宗憲</td>
 </tr>
 <tr>
  <td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
  <td bgcolor="#ECE3D0">便宜</td>
 </tr>
</table><br><br>
