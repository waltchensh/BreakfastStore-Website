...
//Step 3: 選擇資料庫   
		   ...
		   sql="select * from others where id=2";
...
%>
	...
	<form method="post" action="addcart.jsp">
		...
		<p><br><br>
			...
			<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="hidden" name="name" value="雙層肉蛋堡">
		...
		可搭配套餐<br>
		<a href="2.jsp">
			<img src="img/item/2.jpg" alt="蔥抓餅">
		</a>
	</div>
<%	
...
<table style="margin: auto;text-align: center;width: 600px;">
	<tr>
		...
		<td bgcolor="#ECE3D0" style="width:67%;">李諺諺</td>
	</tr>
	<tr>
		<td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
		<td bgcolor="#ECE3D0">這三小阿？</td>
	</tr>
</table><br><br>
<table style="margin: auto;text-align: center;width: 600px;">
	<tr>
		<td bgcolor="#d8c7a0" style="width:33%;">評論者 :&nbsp;</td>
		<td bgcolor="#ECE3D0" style="width:67%;">大肥貓</td>
	</tr>
	<tr>
		<td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
		<td bgcolor="#ECE3D0">今天點名週，可是我覺得這好好吃。</td>
	</tr>
</table><br><br>
</div>
