...
<section id="menu">
    ...
    <div id="setjudge">
	<form  method="post" action="orderdel1.jsp">	
		<table >
			<tr>要刪除訂單
			...
			while(rs.next())
			{
			%><option value="<%=rs.getString("no")%>" ><%=rs.getString("no")%>
			<%}%>
			...
			<tr><input type="submit" value="確認刪除"><input type="reset" value="重設"><a href="back.jsp"><input type="button" value="取消"></a></tr>
		</table>
	</form>
    </div>
