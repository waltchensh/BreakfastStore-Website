...
<main id="main" class="container">
	...
	<div id="Menu">
		<div id="menu-photo">
			<a href="quiche.jsp">
			<img src="img/menu.jpg" alt="蛋餅"
			 onmouseover="this.src='img/quiche.png'"
			 onmouseout="this.src='img/menu.jpg'"></a>
		</div>
		<div id="menu-photo">
			<a href="burger.jsp">
			<img src="img/menu.jpg" alt="漢堡"
			 onmouseover="this.src='img/burger.png'"
			 onmouseout="this.src='img/menu.jpg'"></a>
		</div>
		<div id="menu-photo">
			<a href="other.jsp">
			<img src="img/menu.jpg" alt="其他"
			 onmouseover="this.src='img/other.png'"
			 onmouseout="this.src='img/menu.jpg'"></a>
		</div>
	</div>
