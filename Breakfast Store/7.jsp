...
//Step 3: 選擇資料庫   
		   ...
		   sql="select * from others where id=1";
...
%>
	...
	<form method="post" action="addcart.jsp">
		...
		<p><br><br>
			...
			<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="hidden" name="name" value="異國蔥抓餅">
...
<table style="margin: auto;text-align: center;width: 600px;">
	<tr>
		...
		<td bgcolor="#ECE3D0" style="width:67%;">123</td>
	</tr>
	<tr>
...
<table style="margin: auto;text-align: center;width: 600px;">
	<tr>
		<td bgcolor="#d8c7a0" style="width:33%;">評論者 :&nbsp;</td>
		<td bgcolor="#ECE3D0" style="width:67%;">111</td>
	</tr>
	<tr>
		<td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
		<td bgcolor="#ECE3D0">好喝吃。</td>
	</tr>
</table><br><br>
</div>
