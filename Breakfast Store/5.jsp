...
//Step 3: 選擇資料庫   
		   ...
		   sql="select * from omelet where id=5";
...
%>
	...
	<form method="post" action="addcart.jsp">
		...
		<p><br><br>
			...
			<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="hidden" name="name" value="蔥油蛋餅">
	...
	<div class="side">
		可搭配套餐<br>
		<a href="18.jsp">
			<img src="img/item/18.jpg" alt="豬肉滿福堡">
		</a>
	</div>
...
%>		
	...
	<tr>
		...
		<td bgcolor="#ECE3D0" style="width:67%;">鮮肉</td>
	</tr>
	<tr>
...
<table style="margin: auto;text-align: center;width: 600px;">
	...
	<tr>
		<td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
		<td bgcolor="#ECE3D0">就吃起來都這樣</td>
	</tr>
</table><br><br>
<table style="margin: auto;text-align: center;width: 600px;">
	<tr>
		<td bgcolor="#d8c7a0" style="width:33%;">評論者 :&nbsp;</td>
		<td bgcolor="#ECE3D0" style="width:67%;">不公布</td>
	</tr>
	<tr>
		<td bgcolor="#d8c7a0">評論內容 :&nbsp;</td>
		<td bgcolor="#ECE3D0">勒</td>
	</tr>
</table><br><br>
</div>
